...
<div class="navbar">
    <nav class="navbar navbar-expand-sm bg-light navbar-light">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="/sectorpesquero/vistas/barco/barcoVista.php">EMBARCACIONES</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a style="color:red" class="nav-link" href="/sectorpesquero/vistas/cerrarsesion.php">Cerrar Sesión</a>
            </li>
        </ul>
