        ...
        <div class="formActualizarAgregar">
            <form method="POST" class="my-3 mx-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="contact" name="txtTonelaje" aria-describedby="address" pattern="[\d]{1,5}" title="Ingrese de uno a cinco dígitos" require>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="address" class="form-label">Tipo de embarcación</label>
